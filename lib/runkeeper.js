...
for (func_name in API) {
    HealthGraph.prototype[func_name] = function(callback) {
	var request_details = {
...
HealthGraph.prototype.getUser = function (callback) {
    ...
    // TO DO:  error handling - for now, this assumes a valid access_token in this.access_token
    
    var request_details = {  
	method: "GET",
	headers: {'Authorization' : 'Bearer ' + this.access_token,
		  'Accept' : 'application/vnd.com.runkeeper.User+json '},		  
	uri: "https://" + this.api_domain + "/user"
    };
